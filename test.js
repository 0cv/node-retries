...
needle.requestAsync('get', 'https://raw.github123usercontent.com/tomas/needle/master/pack2age.json', {compressed:true, needleRetry: {retries: 5}}).then(function(response) {
